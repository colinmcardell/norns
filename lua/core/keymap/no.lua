...
k[char_modifier.SHIFT | char_modifier.ALTGR]['7'] = '('
k[char_modifier.SHIFT | char_modifier.ALTGR]['8'] = '{'
k[char_modifier.SHIFT | char_modifier.ALTGR]['9'] = '}'
