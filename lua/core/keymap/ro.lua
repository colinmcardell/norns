...
k[char_modifier.SHIFT | char_modifier.ALTGR] = {}
...
k[char_modifier.ALTGR].APOSTROPHE = '\''
k[char_modifier.ALTGR].DOT = '>'
k[char_modifier.SHIFT | char_modifier.ALTGR].GRAVE = '~'
k[char_modifier.SHIFT | char_modifier.ALTGR].LEFTBRACE = '{'
k[char_modifier.SHIFT | char_modifier.ALTGR].RIGHTBRACE = '}'
k[char_modifier.SHIFT | char_modifier.ALTGR].APOSTROPHE = '"'
