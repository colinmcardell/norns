...
k[char_modifier.SHIFT].W = 'Z'
k[char_modifier.SHIFT].X = 'X'
k[char_modifier.SHIFT].Y = 'Y'
k[char_modifier.SHIFT].Z = 'W'
k[char_modifier.SHIFT]['0'] = '0'
k[char_modifier.SHIFT]['1'] = '1'
k[char_modifier.SHIFT]['2'] = '2'
k[char_modifier.SHIFT]['3'] = '3'
k[char_modifier.SHIFT]['4'] = '4'
k[char_modifier.SHIFT]['5'] = '5'
k[char_modifier.SHIFT]['6'] = '6'
k[char_modifier.SHIFT]['7'] = '7'
k[char_modifier.SHIFT]['8'] = '8'
k[char_modifier.SHIFT]['9'] = '9'
k[char_modifier.SHIFT].GRAVE = '~'
k[char_modifier.SHIFT].EQUAL = '+'
k[char_modifier.SHIFT].BACKSLASH = '|'
k[char_modifier.SHIFT].SEMICOLON = 'M'
k[char_modifier.SHIFT].APOSTROPHE = '%'
k[char_modifier.SHIFT].COMMA = '<'
k[char_modifier.SHIFT].DOT = '/'
k[char_modifier.ALTGR]['2'] = '~'
k[char_modifier.ALTGR]['3'] = '#'
k[char_modifier.ALTGR]['4'] = '{'
k[char_modifier.ALTGR]['5'] = '['
k[char_modifier.ALTGR]['6'] = '|'
k[char_modifier.ALTGR]['7'] = '`'
k[char_modifier.ALTGR]['8'] = '('
k[char_modifier.ALTGR]['0'] = '@'
k[char_modifier.ALTGR].MINUS = ']'
k[char_modifier.ALTGR].EQUAL = '}'
