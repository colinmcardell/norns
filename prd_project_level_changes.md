...
| TASK-023 | Fix SuperCollider environment setup for tests         | TASK-008                     |             | Not Started |          | Ensure SuperCollider extensions directory exists and is properly configured for tests. Update test_sc_installation.cmake to handle missing directories gracefully.                       |
