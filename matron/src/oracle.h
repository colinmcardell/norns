...
extern void o_cut_buffer_copy_mono(int src_ch, int dst_ch, float src_start, float dst_start, float dur, float fade_time,
                                   float preserve, int reverse);
extern void o_cut_buffer_copy_stereo(float src_start, float dst_start, float dur, float fade_time, float preserve,
                                     int reverse);
...
extern void o_cut_buffer_read_stereo(char *file, float start_src, float start_dst, float dur, float preserve,
                                     float mix);
